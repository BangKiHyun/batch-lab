package com.spring.batch.lab.readbook.chap13.configuration;

import com.spring.batch.lab.readbook.chap13.CustomerItemValidator;
import com.spring.batch.lab.readbook.chap13.CustomerUpdate;
import com.spring.batch.lab.readbook.chap13.batch.AccountItemProcessor;
import com.spring.batch.lab.readbook.chap13.batch.CustomerUpdateClassifier;
import com.spring.batch.lab.readbook.chap13.batch.StatementHeaderCallback;
import com.spring.batch.lab.readbook.chap13.batch.StatementLineAggregator;
import com.spring.batch.lab.readbook.chap13.domain.*;
...
public class ImportJobConfiguration {
    ...
    private static final String JOB_NAME = "import_job";
    ...
    public StaxEventItemReader<Transaction> transactionItemReader(@Value("#{jobParameters['transactionFile']}") Resource transactionFile) {
        ...
        unmarshaller.setClassesToBeBound(new Class[]{Transaction.class});
